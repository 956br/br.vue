...
const games = [
  ...
  { slug: 'identity-reveal', title: 'كشف الهوية', img: 'soon.png', desc: 'مرتبطة ببث تيك توك لايف: سجّل بكتابة إجاباتك الخمس بتعليق واحد، ثم خمّن صاحب التلميحات التي تظهر تباعاً قبل غيرك لتفوز وتكشف هويته!' },
];
</script>
