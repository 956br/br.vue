...
const games = [
  ...
  { slug: 'questions', title: 'الامثال القطرية', img: 'Questions.png', desc: 'مرتبطة ببث تيك توك لايف: "1" أو "2" لاختيار الفريق، ووقت السؤال يصوّت أعضاء الفريق على الإجابة بكتابة رقمها (1-4).' },
