...
const games = [
  ...
  { slug: 'card', title: 'خمن الرقم', img: 'card.png', desc: 'مرتبطة ببث تيك توك لايف: "1" للانضمام، وأثناء الجولة يكتب المشاهد "رقمين + اسم الضحية" أو "درع"/"تخطي". تبادل الهجمات وابقَ حياً.' },
  ...
  { slug: 'memory-live', title: 'تحدي الذاكرة', img: 'memory-game.png', desc: 'مرتبطة ببث تيك توك لايف: يكتب المشاهد كلمة الانضمام للتسجيل، ثم يختار المستضيف اللاعبين وعدد النقاط. صاحب الدور يرسل رقمين مثل "3 19" ليفتح تلك البطاقتين ويطابق الصور.' },
  ...
  { slug: 'pipe-race', title: 'شبكة الأنابيب', img: 'pipe-race.webp', desc: 'مرتبطة ببث تيك توك لايف: شبكة أنابيب شفافة متشابكة (بعض المستويات دائرية الشكل) وبلا ألوان، تتبّع تشابكها بعينك واكتب رقم الأنبوب الذي يوصل لوعاء الفوز قبل انتهاء الوقت، ثم شاهد اللون يتدفق داخل الأنبوب الصحيح ليحدد الفائز!' },
