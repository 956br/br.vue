...
const games = [
  ...
  { slug: 'dice', title: 'خمن النرد', img: 'dice.png', desc: 'مرتبطة ببث تيك توك لايف: يكتب المشاهد "بلعب" للانضمام، وأثناء الجولة يكتب توقعه رقمين مثل "1 3". اجمع النقاط واكسب.' },
  { slug: 'card', title: 'معركة الأرقام', img: 'card.png', desc: 'مرتبطة ببث تيك توك لايف: "1" للانضمام، وأثناء الجولة يكتب المشاهد "رقمين + اسم الضحية" أو "درع"/"تخطي". تبادل الهجمات وابقَ حياً.' },
  { slug: 'ships-mines', title: 'المراكب والألغام', img: 'ships-mines.png', desc: 'مرتبطة ببث تيك توك لايف: "1" أو "2" لاختيار الفريق، ووقت دور فريقك تصوّت بكتابة رقم المربع. دوّر المراكب وتجنب القنابل.' },
  ...
  { slug: 'memory-live', title: 'الذاكرة', img: 'memory-game.png', desc: 'مرتبطة ببث تيك توك لايف: يكتب المشاهد كلمة الانضمام للتسجيل، ثم يختار المستضيف اللاعبين وعدد النقاط. صاحب الدور يرسل رقمين مثل "3 19" ليفتح تلك البطاقتين ويطابق الصور.' },
  ...
  { slug: 'apple-solo', title: 'التقط التفاح الفردي', img: 'apple-solo.png', desc: 'مرتبطة ببث تيك توك لايف: اكتب "1" أو أرسل هدية للانضمام، ثم تحكم بشخصيتك الخاصة بكتابة "فوق/تحت/يمين/يسار" لالتقاط أكبر عدد من التفاح في نسختك الفردية.' },
  ...
  { slug: 'luggage', title: 'وزن الشنطة', img: 'luggage.png', desc: 'مرتبطة ببث تيك توك لايف: أثناء العد التنازلي يكتب كل مشاهد رقماً كتوقع لوزن الشنطة، وآخر رقم يكتبه هو المعتمد. الأقرب للوزن الفعلي يفوز.' },
  { slug: 'maze', title: 'المتاهة', img: 'maze.png', desc: 'مرتبطة ببث تيك توك لايف: سجّل بكتابة مفتاح الانضمام قبل إغلاق التسجيل، ثم اكتب مسار حركتك الكامل نحو أحد الأبواب الأربعة بتعليق واحد لاجتياز المتاهة.' },
  ...
  { slug: 'vault', title: 'الخزنة', img: 'vault.png', desc: 'مرتبطة ببث تيك توك لايف: بدون تسجيل مسبق، حاول فتح الخزنة بكتابة تسلسل الرموز/الأرقام الصحيح بالدردشة قبل غيرك.' },
  { slug: 'wb', title: 'عجلة المربعات', img: 'wb.png', desc: 'مرتبطة ببث تيك توك لايف: اكتب مفتاح الانضمام أو أرسل هدية قبل إغلاق التسجيل، ثم أدر العجلة لاختيار لاعب يكتب رقم مربع فينفتح ويكشف جائزة أو إقصاء.' },
  { slug: 'dark-room', title: 'كشف المخبأ', img: 'dark-room.png', desc: 'مرتبطة ببث تيك توك لايف: يختبئ المستضيف برقم سري داخل شبكة مرقمة، ومن يكتب رقم المربع الصحيح بالدردشة يفوز بنقطة الجولة!' },
  { slug: 'pipe-race', title: 'سباق الأنابيب', img: 'pipe-race.webp', desc: 'مرتبطة ببث تيك توك لايف: شبكة أنابيب شفافة متشابكة (بعض المستويات دائرية الشكل) وبلا ألوان، تتبّع تشابكها بعينك واكتب رقم الأنبوب الذي يوصل لوعاء الفوز قبل انتهاء الوقت، ثم شاهد اللون يتدفق داخل الأنبوب الصحيح ليحدد الفائز!' },
